...
plotQQ(z_lo4,"grey65",0.3);
#plotQQ(z_lo5,"grey75",0.3);
#plotQQ(z_lo6,"grey85",0.3);
...
paste("MAF < 0.01 [",length(z_lo4),"]")),
pch=c((vector("numeric",5)+1)*23), cex=c((vector("numeric",5)+0.8)), pt.bg=c("red","black","olivedrab1","orange","lightskyblue", "grey65"))
rm(z)
dev.off()
